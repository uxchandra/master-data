<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 leading-tight">Edit Role: {{ $role->name }}</h2>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('user-management.roles.update', $role) }}" class="space-y-5">
                    @csrf @method('PUT')
